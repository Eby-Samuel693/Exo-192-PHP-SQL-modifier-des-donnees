 ...
 * 2. Trouvez comment importer cette table dans une des bases de données que vous avez
 *      créées, si vous le souhaitez vous pouvez en créer une nouvelle pour cet exercice.
 ...
 * 6. Modifiez cet utilisateur directement après avoir envoyé les données ( on
 *      imagine que vous vous êtes trompé )
 */
$server = 'localhost';
$db = 'bdd_cours';
$user = 'root';
...
try {
    ...
    $requestU = "
       ...
       VALUES('Sam','Coquelet','st aubin',6,59330,'limond-fontaine','france','sam.coquelet@gmail.com')
   ";
$pdo->exec($requestU);
